...
def MobileNetV2(input_shape,class_num,input_tensor,**kargs):
    ...
    input_data = KL.Input(input_shape)
    ...
    #pred = keras.activations.softmax(fc)
...
if __name__ == '__main__':
    a = K.ones(shape=(1,224,224,3))
    net = MobileNetV2([224,224,3],80,a)
    #net = test()
    vis_net(net)