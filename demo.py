...
class MaskInference(object):
    ...
    def detectfrompath(self,img_path):
        self.images = [skimage.io.imread(img_path)]
        t1 = time.time()
...
if __name__ == '__main__':
    ...
    image_path = "/home/lxy/Develop/faster_rcnn/Mask_RCNN/images/8239308689_efa6c11b08_z.jpg"
    img_p = "/home/lxy/Develop/Center_Loss/git_prj/BaiduImageSpider/img_dw/mobile/236.jpg"
    image1 = skimage.io.imread("/home/lxy/Develop/faster_rcnn/Mask_RCNN/images/3975_20.jpg")
    image2 = skimage.io.imread("/home/lxy/Develop/faster_rcnn/Mask_RCNN/images/8973_0.jpg")
    ...
    mask_net.swapbackground(img_p,image_ground,save_ps)
    mask_net.show_mask()
