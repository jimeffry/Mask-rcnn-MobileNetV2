...
class Config(object):
    ...
    # Supported values are: resnet50, resnet101,mobilenet
    ...
    # How many target anchors are built per image to use for RPN training
    RPN_TRAIN_ANCHORS_PER_IMAGE = 256
    # how many proposals per image to use for detect and mask trainin
    # for 640x640, the max num:307200
    PROPOSAL_TRAIN_PER_IMAGE = 6000 
    ...
    #How many target rois are built,for detect net to training. TRAIN_ROIS_PER_IMAGE / ROI_POSITIVE_RATIO <= RPN_Output_Num
    ...
    debug_anchor = 0
    debug = 0
    #using plot_model to display model frame
    displaymodel = 0
